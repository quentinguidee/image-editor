...
void RoundedRectangle::draw(SDL_Renderer* renderer, const Position& offset, const Size& maxSize) const
{
    drawFill(renderer, offset, maxSize);
}

void RoundedRectangle::drawFill(SDL_Renderer* renderer, const Position& offset, const Size& maxSize) const
{
